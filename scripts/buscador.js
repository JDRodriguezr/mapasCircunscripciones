const archivoJSON = [
  ...
  },
  {
    Consuladuria: 'GUAYAQUIL',
    Provincia: 'GUAYAS',
    Cantón: 'ORONEL MARCELINO MARIDUE',
  ...
  {
    Consuladuria: 'SANTO DOMINGO DE LOS COLORADOS',
    Provincia: 'LOS RIOS',
    Cantón: 'QUEVEDO',
    Parroquia: 'QUEVEDO',
  },
  ...
  },
  {
    Consuladuria: 'NUEVA LOJA',
    Provincia: 'NAPO',
    Cantón: 'ARLOS JULIO AROSEMENA TOL',
  ...
  },
  {
    ...
    Provincia: 'GALAPAGOS',
    Cantón: 'SAN CRISTÓBAL',
    Parroquia: 'A SANTA MARÍA (FLOREANA) (CAB. EN PTO. VELASCO IBARR',
  },
  {
    Consuladuria: 'GUAYAQUIL',
    Provincia: 'GALAPAGOS',
  ...
  {
    Consuladuria: 'SANTO DOMINGO DE LOS COLORADOS',
    Provincia: 'NTO DOMINGO DE LOS TSACHIL',
  ...
  },
  {
    ...
    Cantón: 'LAS GOLONDRINAS',
    Parroquia: 'LAS GOLONDRINAS',
  },
  {
    Consuladuria: 'Otro',
    Provincia: 'ZONAS NO DELIMITADAS',
    Cantón: 'MANGA DEL CURA',
...
refreshImg.addEventListener('click', limpiarResultados);
...
function generateTable(respuestaJson, pagina) {
  ...
  for (let i = (pagina-1)*20; i < iteraciones /*respuestaJson.length*/; i++) {
    ...
    for (let j = 0; j < 1; j++) {
      ...
      const carta = darClaseSegunCircunscripcion(
        cell,
    ...
    for (let j = 0; j < 1; j++) {
      ...
      const cellText = document.createTextNode(
        `${JSON.stringify(respuestaJson[i].Provincia).replace(/['"]/g, '')}`
      );
    ...
    for (let j = 0; j < 1; j++) {
      const cell = document.createElement('td');
      const cellText = document.createTextNode(
        `${JSON.stringify(respuestaJson[i].Cantón).replace(/['"]/g, '')}`
      );
      cell.appendChild(cellText);
      row.appendChild(cell);
    }
  ...
  function darClaseSegunCircunscripcion(elemento, texto) {
    switch (texto) {
      case 'GUAYAQUIL':
        ...
        const cardGUAYAQUIL = document.createElement('span');
      ...
      case 'TULCAN':
        ...
        const cardTULCAN = document.createElement('span');
      ...
      case 'QUITO':
        ...
        const cardQUITO = document.createElement('span');
      ...
      case 'ESMERALDAS':
        ...
        const cardESMERALDAS = document.createElement('span');
      ...
      case 'NUEVA LOJA':
        ...
        const cardNuevaLoja = document.createElement('span');
      ...
      case 'Otro':
        ...
        const cardOtro = document.createElement('span');
...
function displayCard(imgPath, elt) {
  ...
  cardOnHover.style.top = mousePos.y + 20 + 'px';

  let difference = document.documentElement.clientWidth - elt.offsetLeft;

  cardOnHover.style.top = mousePos.y + 10 + window.scrollY + 'px';

  if (mousePos.x < 400) {
    cardOnHover.style.left = mousePos.x - 100 + 'px';
  } else {
    cardOnHover.style.left = mousePos.x - 300 + 'px';
  }
